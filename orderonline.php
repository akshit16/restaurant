                    ...
                    ?>
                        ...
                        <div id="9" class="tab-pane fade ">
                          ...
                          while ($row =  mysqli_fetch_array($res) ){
                            ...
                            echo '</td><td>';
                            echo "<div class='addp'><span>";
                             echo'<button type="button" class="minus" name = "ms'.$count.'" value="'.$row['id'].'">-</button>';
                              echo  '<span class="figure" id = "fs'. $count.'">0</span>';
                            echo '<input type="hidden" name="figvalue" value="0" class="figvalue">';
                            echo '<button type="button" class="plus" name = "ps'.$count.'" value="'.$row['id'].'" >+</button>';
                            echo '</span></div>';
                            echo "</td></tr>";
                            $count++;
                        ...
                        <aside>
                             <div class="single-widget my-cart detail-cart">
                              ...
                              <div class="total-top-rated">
                                    <ul>
                                       <?php  echo'<li>';
                                       $result ="select id,Dish,Price,Quantity from cart where user ='{$_SESSION["user"]}'  ";
