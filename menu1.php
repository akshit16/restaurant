...
$rows = array();
$resul ="select Dish,Price from menu where Category ='Chinese'  ";
$re= mysqli_query($conn,$resul);
$rowcnt = mysqli_num_rows($re); 
$rows = array();
$resu ="select Dish,Price from menu where Category ='Tandoori'  ";
$r= mysqli_query($conn,$resu);
$rowcn = mysqli_num_rows($r); 
$rows = array();
  $sq ="select Dish,Price from menu where Category ='Beverages'  ";
$ses= mysqli_query($conn,$sq);
$rowc = mysqli_num_rows($ses); 
$rows = array(); 
$s ="select Dish,Price from menu where Category ='Rice'  ";
$se= mysqli_query($conn,$s);
$rowcl = mysqli_num_rows($se); 
$rows = array();
$lot ="select Dish,Price from menu where Category ='Curd/Raita'  ";
$tes= mysqli_query($conn,$lot);
$rowck = mysqli_num_rows($tes); 
$rows = array();
$lop ="select Dish,Price from menu where Category ='Mutton and Egg'  ";
$te= mysqli_query($conn,$lop);
$rowco = mysqli_num_rows($te); 
$rows = array();
$kop ="select Dish,Price from menu where Category ='Papad and Salad'  ";
$oo= mysqli_query($conn,$kop);
$rowcq = mysqli_num_rows($oo); 
$rows = array();
      //  foreach ($rows as $row) {
          ?>
<!doctype html>
                  ...
                  <div class="sma-middle sma-last mt60 bac-right">
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="total-menu-item carsoule-btn smp-carsoule">
                            <div class="total-menu-single">
                               <div class="single-menu-item">
                                   <div class="smi-heading"><?php 
                                                                         while ($sow =  mysqli_fetch_array($r))
    {
        //$rows[] = $row;
    print $sow['Dish']."<br>";
    print $sow['Price']."<br>";
                        ...
                        <div class="total-menu-item carsoule-btn smp-carsoule">
                            <div class="total-menu-single">
                               <div class="single-menu-item">
                                   <div class="smi-heading">
                                        <?php 
                                    while ($low =  mysqli_fetch_array($ses))
    {
        //$rows[] = $row;
    print $low['Dish']."<br>";
                                   print $low['Price']."<br>"; }?>
                            ...
                            <div class="total-menu-single">
                               <div class="single-menu-item">
                                   <div class="smi-heading">
                                      ...
                                      <?php 
                                    while ($pow =  mysqli_fetch_array($tes))
    {
        //$rows[] = $row;
    print $pow['Dish']."<br>";
                                   print $pow['Price']."<br>"; }?>
                        ...
                        <div class="total-menu-item carsoule-btn smp-carsoule">
                            <div class="total-menu-single">
                               <div class="single-menu-item">
                                   <div class="smi-heading">
                                     <?php 
                                    while ($lo =  mysqli_fetch_array($se))
    {
        //$rows[] = $row;
    print $lo['Dish']."<br>";
                                   print $lo['Price']."<br>"; }?>
                        ...
                        <div class="total-menu-item carsoule-btn smp-carsoule">
                            <div class="total-menu-single">
                               <div class="single-menu-item">
                                   <div class="smi-heading">
                                       <?php 
                                    while ($tow =  mysqli_fetch_array($te))
    {
        //$rows[] = $row;
    print $tow['Dish']."<br>";
                                   print $tow['Price']."<br>"; }?>
